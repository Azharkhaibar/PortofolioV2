...
const PortofolioBody = () => {
    ...
    const handleItemClick = (index) => {
        ...
        setActiveSection(index); // Change section based on clicked index
    };
                ...
                {activeSection === 0 && 
                    <div className="w-10/12 h-auto mx-auto">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-5 w-full h-auto">
                            {ProjectFlex.map((project, index) => (
                                <div key={index} className=" p-6 rounded-lg bg-gray-800 shadow-lg hover:shadow-xl transition-shadow duration-300">
                                    <img
                                    ...
                                    <div className="text-white">
                                        <h2 className="text-2xl font-semibold mb-2">{project.nameproject}</h2>
                                        <p className="text-md text-gray-400">{project.descriptionproject}</p>
                                    </div>
                                    <div className="flex items-center justify-between mt-4">
                                        <h3 className="text-blue-300">Live Demo</h3>
                                        <button className="py-2 px-5 bg-gray-700 text-white rounded-xl flex items-center gap-3">Details
